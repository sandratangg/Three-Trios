...
import cs3500.threetrios.provider.model.ProviderIGrid;
 ...
 */
public class ProviderGridPanel extends AbstractGridPanel {
  private ProviderIGrid grid;
  ...
  public void paintComponent(Graphics g) {
    ...
    for (int rowIdx = 0; rowIdx < gridHeight; rowIdx++) {
      ...
      for (int colIdx = 0; colIdx < gridWidth; colIdx++) {
        ...
        g2d.draw(cellBorder);
        // Draw cards/cells
        ProviderICell cell = grid.getCell(rowIdx, colIdx);
  ...
  @Override
  void setGrid(ProviderIGrid grid) {
