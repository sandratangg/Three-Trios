...
public class ThreeTriosView extends JFrame implements IThreeTriosView {
  private AbstractGridPanel gridPanel;
  private AbstractPlayerHandPanel redPlayerHandPanel;
  private AbstractPlayerHandPanel bluePlayerHandPanel;
   ...
   */
  public ThreeTriosView(IThreeTriosViewModel model) {
    this.model = Objects.requireNonNull(model, "Model cannot be null");

    // Set up hand and grid panels
    gridPanel = new GridPanel();
    redPlayerHandPanel = new PlayerHandPanel(PlayerColor.RED);
    bluePlayerHandPanel = new PlayerHandPanel(PlayerColor.BLUE);
    setUpGUI();
  }
